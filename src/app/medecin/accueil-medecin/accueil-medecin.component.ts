...
export class AccueilMedecinComponent implements OnInit {
  ...
  constructor(private modal: NgbModal, private medecinService: MedecinService, private consultationService: ConsultationService, private router: Router, private route: ActivatedRoute) { }
